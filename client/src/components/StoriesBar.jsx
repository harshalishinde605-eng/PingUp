    ...
    return(
        <div className='w-screen sm:w-[calc(100vw-240px)] lg:max-w-2xl no-scrollbar overflow-x-auto px-4'>
            ...
            <div className='flex gap-4 pb-5'>
                <div onClick={()=>setShowModel(true)}className='rounded-lg shadow-sm min-w-30 max-w-30 max-h-40 aspect-[3/4] cursor-pointer hover:shadow-lg transition-all diration-200 border-2 border-dashed border-yellow-500 bg-gradient-to-b from-yellow-50 to-white'>
            ...
            
                {
                    stories.map((story,index)=> (
                        <div onClick={()=> setViewStory(story)} key={index} className={`relative rounded-lg shadow min-w-30 max-w-30 max-h-40 cursor-pointer hover:shadow-lg transition-all duration-200 bg-gradient-to-b from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 active:scale-95`}>
            ...
            {showModel && <StoryModel setShowModel={setShowModel} fetchStories={fetchStories}></StoryModel>}
