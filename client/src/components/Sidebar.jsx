  ...
  return(
    <div className={`w-60 xl:w-72 bg-white border-r border-gray-200 flex flex-col justify-between items-center max-sm:absolute top-0 bottom-0 z-20 ${sidebarOpen ? 'translate-x-0' : 'max-sm:-translate-x-full'} transition-all duration-300 ease-in-out`}>
        <div className='w-full'>
            ...
            <Link to='/create-post' className='flex items-center justify-center gap-2 py-2.5 mt-6 mx-6 rounded-lg bg-gradient-to-r from-yellow-300 to-yellow-500 hover:from-yellow-500 hover:to-yellow-600 active:scale-95 transition text-white cursor-pointer'>
        ...
        <div className='w-full border-t border-gray-200 p-4-px-7 flex items-center justify-between'>
          ...
          // This color will ONLY apply to this SignUp component
                    colorPrimary: 'rgba(198, 203, 54, 1)', 
                    colorBackground: '#e4e477ff',
                    colorInput: '991B1B'
        },
      }}/>
              <div>
